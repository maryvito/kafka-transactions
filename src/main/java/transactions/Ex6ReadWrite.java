...
import utis.AbstractConsumer;
import utis.LoggingConsumer;
import utis.Utils;
...
public class Ex6ReadWrite {
    public static void main(String[] args) throws Exception {
        ...
        try (
                var producer = new KafkaProducer<>(Utils.createProducerConfig(b -> {
                    b.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "ex6");
                }));
